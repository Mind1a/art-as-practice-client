    ...
    <header className="relative mx-auto flex w-full items-center justify-between px-4 py-4 lg:max-w-[1440px] lg:px-8">
      ...
      <div className="hidden items-center justify-between gap-4 lg:flex">
        ...
        <CustomButton
          text="Registration"
          href="/"
          className="flex w-[120px] items-center justify-center bg-[#F2430D] text-center text-[15px] text-white transition-colors duration-300 ease-in-out hover:bg-[#B74C2C]"
        />
      </div>
      <BurgerMenu />
    </header>
